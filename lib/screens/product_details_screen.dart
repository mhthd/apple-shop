...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  void initState() {
    super.initState();
    BlocProvider.of<ProductBloc>(context).add(ProductDetailInitializeEvent());
  }
            ...
            return CustomScrollView(
              slivers: <Widget>[
                ...
                if (state is ProductResponseState) ...{
                  state.productImageList.fold((errorMessage) {
                    return SliverToBoxAdapter(
                      child: Text(errorMessage),
                    );
                  }, (productImageList) {
                    return ProductGallery(productImageList);
                  }),
                },
                SliverToBoxAdapter(
                  child: Column(
                ...
                const SliverToBoxAdapter(
                  child: Padding(
                    padding: EdgeInsets.only(
                        top: 38, bottom: 32, left: 50, right: 50),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        PriceTagButton(),
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: SizedBox(
                    ...
                    child: CachedImage(
                        imageUrl:
                            widget.productImageList[_selectedItem].imageUrl),
                    // Image.asset(
